...
# Usage in your flake:
#
#   inputs.freeflow.url = "github:USS-Parks/FreeFlow";
#
#   nixosConfigurations.myhost = nixpkgs.lib.nixosSystem {
#     modules = [
#       freeflow.nixosModules.default
#       { programs.freeflow.enable = true; }
#     ];
#   };
{
  config,
...
let
  cfg = config.programs.freeflow;
in
{
  options.programs.freeflow = {
