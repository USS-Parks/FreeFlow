  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          freeflow = pkgs.rustPlatform.buildRustPackage {
            pname = "freeflow";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/USS-Parks/FreeFlow";
              license = lib.licenses.mit;
              mainProgram = "freeflow";
              platforms = supportedSystems;
            };
          };

          default = self.packages.${system}.freeflow;
        }
      );
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.freeflow.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.freeflow;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.freeflow.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.freeflow;
        };
