...
Status: **Approved — STS active; FF-G1 through FF-G4, FF-V1 through FF-V6, FF-P1 through FF-P5, and FF-A1 through FF-A4 complete; Milestones G, V, P, and A implementation complete; retained live matrices assigned to FF-R2; FF-X1 in progress**
Version: 2.5
Date: 2026-07-19
...
| 2026-07-19 | 2.1 execution     | FF-P5 candidate `44c9ac6b8371440e20aa440542396022dbbeb3e0` added local process classification, typed per-category formatting/context profiles, default-off minimum surrounding-text capture, exact application denylisting, remote/secure fail-closed policy, and redacted visible diagnostics. Hosted run `29700140823` passed native Windows/macOS, provenance, and security.                                                                                                                                                        | Milestone P implementation is complete and FF-A1 is next. The retained interactive application-context matrix remains mandatory at FF-R2.                                                                                                   |
| 2026-07-19 | 2.2 execution     | FF-A1 candidate `ba0bc09b0cc3d19d1d4bbc7b3c0157808fc9a9fb` added a consent-bound pinned llama.cpp runtime and SmolLM2 model, local-only provider migration, resource-aware CPU/Vulkan/Metal selection, bounded loopback execution, cancellation, timeout, corrupt-model rejection, and lossless raw fallback. Hosted live run `29703174180` passed CPU/Vulkan on Windows and CPU/Metal on Apple Silicon; native run `29703174188` passed Windows/macOS, provenance, and security.                                                      | FF-A1 is complete and FF-A2 is next. Milestone A hardware-tier acceptance remains owned by its final milestone and FF-R2 release evidence.                                                                                                  |
| 2026-07-19 | 2.3 execution     | FF-A2 candidate `e91171dd7eb36098ec5444f0df799296cd3cf5cb` added explicit cleanup strengths, deterministic pre-transform backtrack, original per-application styles, semantic fail-closed validation, and reversible raw/final review. Hosted run `29705327094` passed Windows/macOS native tests, provenance, and security.                                                                                                                                                                                                           | FF-A2 is complete and FF-A3 is next. Milestone A hardware-tier acceptance remains owned by its final milestone and FF-R2 release evidence.                                                                                                  |
| 2026-07-19 | 2.4 execution     | FF-A3 candidate `e22b9022578a9cca02e37e6fb759ff8b37a58dea` added configurable local transform slots, fail-closed explicit selection capture, exact diff and replacement validation, accept/undo/retry/copy actions, dynamic shortcut registration, and bounded local writing samples. Hosted run `29708191017` passed Windows/macOS native tests, provenance, and security.                                                                                                                                                            | FF-A3 is complete and FF-A4 is next. The representative application, native-undo, and selection-replacement matrix remains mandatory at FF-R2.                                                                                              |
| 2026-07-19 | 2.5 execution     | FF-A4 candidate `b3fd93859bf8041368057f765b485e9047a5cd5c` added coordinator-owned hold-to-speak local commands, guarded selection/cursor delivery, lossless copy fallback, remote-action rejection, and explicit confirmation before supported preference changes. Hosted run `29710154681` passed Windows/macOS native tests, provenance, and security.                                                                                                                                                                              | Milestone A implementation is complete and FF-X1 is next. The representative command-mode application matrix and hardware-tier acceptance remain mandatory at FF-R2.                                                                        |
