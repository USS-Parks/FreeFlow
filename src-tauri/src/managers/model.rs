    ...
    pub fn new(app_handle: &AppHandle) -> Result<Self> {
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:ggml-small.bin".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:whisper-medium-q4_1.bin".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:ggml-large-v3-turbo.bin".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:ggml-large-v3-q5_0.bin".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:breeze-asr-q5_k.bin".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:parakeet-v2-int8.tar.gz".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:parakeet-v3-int8.tar.gz".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:moonshine-base.tar.gz".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:moonshine-tiny-streaming-en.tar.gz".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:moonshine-small-streaming-en.tar.gz".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:moonshine-medium-streaming-en.tar.gz".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:sense-voice-int8.tar.gz".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:giga-am-v3-int8.tar.gz".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:canary-180m-flash.tar.gz".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:canary-1b-v2.tar.gz".to_string(),
                    sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "disabled-model-source:cohere-int8.tar.gz".to_string(),
                    sha256: Some(
...
mod tests {
    ...
    fn test_discover_hf_cache_models_filters_by_arch() {
        ...
        let repo = root.join("models--example-org--whisper-test");
        ...
        let id = "example-org/whisper-test/whisper-q8.gguf";
        ...
        assert!(
            ...
            if repo_id == "example-org/whisper-test" && revision == "main")
        );
        assert_eq!(
